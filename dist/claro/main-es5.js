...
var ApiRestService = /** @class */ (function () {
    ...
    ApiRestService.prototype.getDividasClaroMovel = function () {
        var _this = this;
        ...
        this.dividasClaroMovel.Divida.DadosDivida.forEach(function (divida) {
            _this.opcoesPgTitulo[divida.CodigoTitulo] = new OpcoesPagamento();
    ...
    ApiRestService.prototype.getAllOpcoesClaroMovel = function () {
        ...
        this.dividasClaroMovel.Divida.DadosDivida.forEach(function (divida) {
            _this.getOpcoesPagamento(divida.CodigoTitulo).subscribe(function (opc) {
                _this.opcoesPgTitulo[divida.CodigoTitulo] = opc;
                _this.opcoesPg.next(_this.opcoesPgTitulo[divida.CodigoTitulo]);
                console.log(_this.opcoesPg);
            });
        });
    };
    ApiRestService.prototype.getDividasClaroInternet = function () {
        return this.dividas.Divida.DadosDivida.filter(function (div) { return div.Produto === "Claro Internet"; });
    };
    ApiRestService.prototype.getDividasClaroTv = function () {
        return this.dividas.Divida.DadosDivida.filter(function (div) { return div.Produto === "Claro TV"; });
    };
...
var NegocieOnlineComponent = /** @class */ (function () {
    ...
    NegocieOnlineComponent.prototype.getOpcaoAVista = function (codTitulo) {
