...
var AcordosAndamentoComponent = /** @class */ (function () {
    function AcordosAndamentoComponent(apiRestService, router) {
    ...
    AcordosAndamentoComponent.prototype.ngOnInit = function () {
        ...
        if (this.apiRestService.acordos.length) {
            this.apiRestService.acordos.forEach(function (acc) {
                _this.acordos.push(acc);
            });
        }
    ...
    AcordosAndamentoComponent.prototype.getIcon = function (acordo) {
    ...
    AcordosAndamentoComponent.prototype.segunda_via = function (codAcordo, codCodigoAcordo, numeroTitulo, ind) {
        var _this = this;
        numeroTitulo = numeroTitulo.split('.')[0];
        this.loadingBoleto[ind] = true;
        console.log(codCodigoAcordo);
        this.apiRestService.getBoletoAcordo(codAcordo, codCodigoAcordo).subscribe(function (bol) {
            console.log(bol);
            _this.loadingBoleto[ind] = false;
            if (bol.BoletoAcordo) {
                ...
                _this.router.navigate(['/boleto'], { queryParams: { data: bol.BoletoAcordo.DataVencimento,
                        linha: bol.BoletoAcordo.LinhaDigitavel,
                        valor: _this.apiRestService.doisDigitosDecimais(bol.BoletoAcordo.Valor),
                        cliente: _this.apiRestService.devedor.Devedores.Devedor.Nome,
                        contrato: numeroTitulo
                    } });
            }
            else {
                _this.erroBoleto = true;
            }
        });
    };
    AcordosAndamentoComponent.prototype.voltarEmail = function () {
        this.porEmail = false;
        this.sucessoEmail = false;
        this.accDividas = true;
    };
    AcordosAndamentoComponent.prototype.voltarSms = function () {
        this.porSms = false;
        this.accDividas = true;
    };
    AcordosAndamentoComponent.prototype.enviarSms = function () {
        var _this = this;
        this.apiRestService.enviaSms(this.boleto.BoletoAcordo.LinhaDigitavel, this.boleto.BoletoAcordo.DataVencimento, this.apiRestService.doisDigitosDecimais(this.boleto.BoletoAcordo.Valor)).subscribe(function (res) {
            _this.smsRes = JSON.parse(res).statusDescription;
            _this.accDividas = true;
            _this.porSms = false;
        });
    };
    AcordosAndamentoComponent.prototype.pegarTelefone = function (ind, codAcordo, codTitulo) {
        var _this = this;
        var codigoParcelaAcordo;
        this.loadingBoleto[ind] = true;
        this.emailRes = '';
        this.smsRes = '';
        console.log("acoordo=");
        console.log(codTitulo);
        this.apiRestService.getDadosAcordo(codTitulo).subscribe(function (acc) {
            console.log("acc=");
            console.log(acc);
            ...
            _this.apiRestService.getBoletoAcordo(codAcordo, codigoParcelaAcordo).subscribe(function (bol) {
                _this.loadingBoleto[ind] = false;
                _this.accDividas = false;
                console.log("bol=");
                console.log(bol);
                if (bol.BoletoAcordo) {
                    _this.porSms = true;
    ...
    AcordosAndamentoComponent.prototype.pegarEmail = function (ind, codAcordo, codTitulo, numTitulo) {
        var _this = this;
        var codigoParcelaAcordo;
        this.smsRes = '';
        this.loadingBoleto[ind] = true;
    ...
    AcordosAndamentoComponent.prototype.enviarEmail = function () {
        var _this = this;
        this.apiRestService.enviaBoletoEmail(this.numTitulo, this.boleto.BoletoAcordo.Valor, this.boleto.BoletoAcordo.DataVencimento, this.boleto.BoletoAcordo.LinhaDigitavel, this.apiRestService.email).subscribe(function (res) {
            _this.emailRes = res.message;
            _this.accDividas = true;
            _this.porEmail = false;
        });
    };
    AcordosAndamentoComponent.ctorParameters = function () { return [
...
var ApiRestService = /** @class */ (function () {
    ...
    ApiRestService.prototype.temDividasouAcordo = function (cpfCnpj) {
        var _this = this;
        this.cpfCnpj = cpfCnpj;
        return this.getDadosDevedor(cpfCnpj).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(function (devedor) {
            if (devedor.Codigo === '27')
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(0);
            if (devedor.Codigo === '10') {
                if (!devedor.Devedores)
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(0);
                _this.devedor = devedor;
                console.log(devedor);
                return _this.getDadosDivida(cpfCnpj, devedor.Devedores.Devedor.CodigoDevedor).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (divida) {
                    console.log(divida);
                    if (divida.Codigo !== '23' && divida.Codigo !== '10')
                        return 2;
                    _this.dividas = divida;
                    if (divida.Acordo) {
                        _this.acordos = divida.Acordo.DadosAcordo;
                        return 1;
                    }
                    if (divida.Divida)
                        return 1;
    ...
    ApiRestService.prototype.getDadosDevedor = function (cpfCnpj) {
        var cpfCnpjParam = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('cpf', cpfCnpj);
    ...
    ApiRestService.prototype.getDadosDivida = function (cpfCnpj, codDevedor) {
        var cpfDevedorParam = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]()
            .set('cpf', cpfCnpj)
    ...
    ApiRestService.prototype.getOpcoesPagamento = function (codTitulo) {
        var cpfCnpjParam = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('codigotitulo', codTitulo)
    ...
    ApiRestService.prototype.getDadosAcordo = function (codTitulo) {
        var cpfCnpjParam = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('codigotitulo', codTitulo)
            .set('cpf', this.cpfCnpj);
    ...
    ApiRestService.prototype.getBoletoAcordo = function (codAcordo, codCodigoAcordo) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('codigoacordo', codAcordo)
    ...
    ApiRestService.prototype.enviaSms = function (codigobarra, vencimento, valor) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('nome', this.devedor.Devedores.Devedor.Nome.toLocaleUpperCase())
    ...
    ApiRestService.prototype.gravaAcordo = function (codTitulo, cpf, codDevedor, codPlano, vencimentoPrimeira, valorPrimeira) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('codigotitulo', codTitulo)
            .set('cpf', cpf)
            .set('codigodevedor', codDevedor)
    ...
    ApiRestService.prototype.enviaBoletoEmail = function (contrato, valor, vencimento, linha, email) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('cliente', this.devedor.Devedores.Devedor.Nome.toLocaleUpperCase())
            .set('cpf', this.cpfCnpj)
    ...
    ApiRestService.prototype.getDividas = function () {
        ...
        if (this.dividas.Divida.DadosDivida.length) {
            this.dividasClaroMovel.Divida.DadosDivida = this.dividas.Divida.DadosDivida.filter(function (div) { return div.Produto === "Claro Móvel"; });
            this.dividasClaroInternet.Divida.DadosDivida = this.dividas.Divida.DadosDivida.filter(function (div) { return div.Produto === "Claro Internet"; });
            this.dividasClaroTv.Divida.DadosDivida = this.dividas.Divida.DadosDivida.filter(function (div) { return div.Produto === "Claro TV"; });
            this.dividasClaroFixo.Divida.DadosDivida = this.dividas.Divida.DadosDivida.filter(function (div) { return div.Produto === "Claro Fixo"; });
        }
        else {
    ...
    ApiRestService.prototype.getAllOpcoesClaroMovel = function () {
        var _this = this;
        if (this.opcoesPg[this.dividasClaroMovel.Divida.DadosDivida[0].CodigoTitulo])
            return true;
        this.dividasClaroMovel.Divida.DadosDivida.forEach(function (divida) {
            _this.opcoesPg[divida.CodigoTitulo] = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]({
                Carregando: true,
                OpcoesPagamento: {
                    OpcaoPagamento: {
            ...
            _this.getOpcoesPagamento(divida.CodigoTitulo).subscribe(function (opc) {
                opc.Carregando = false;
                _this.opcoesPg[divida.CodigoTitulo].next(opc);
            });
        });
    };
    ApiRestService.prototype.getAllOpcoesClaroTv = function () {
        var _this = this;
        if (this.opcoesPg[this.dividasClaroTv.Divida.DadosDivida[0].CodigoTitulo])
            return true;
        this.dividasClaroTv.Divida.DadosDivida.forEach(function (divida) {
            _this.opcoesPg[divida.CodigoTitulo] = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]({
                Carregando: true,
                OpcoesPagamento: {
                    OpcaoPagamento: {
    ...
    ApiRestService.prototype.getAllOpcoesClaroInternet = function () {
        var _this = this;
        if (this.opcoesPg[this.dividasClaroInternet.Divida.DadosDivida[0].CodigoTitulo])
            return true;
        this.dividasClaroInternet.Divida.DadosDivida.forEach(function (divida) {
            _this.opcoesPg[divida.CodigoTitulo] = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]({
                Carregando: true,
                OpcoesPagamento: {
                    OpcaoPagamento: {
    ...
    ApiRestService.prototype.getAllOpcoesClaroFixo = function () {
        var _this = this;
        if (this.opcoesPg[this.dividasClaroFixo.Divida.DadosDivida[0].CodigoTitulo])
            return true;
        this.dividasClaroFixo.Divida.DadosDivida.forEach(function (divida) {
            _this.opcoesPg[divida.CodigoTitulo] = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]({
                Carregando: true,
                OpcoesPagamento: {
                    OpcaoPagamento: {
    ...
    ApiRestService.prototype.doisDigitosDecimais = function (num) {
        num = num.replace(',', '.');
    ...
    ApiRestService.ctorParameters = function () { return [
...
var Divida = /** @class */ (function () {
    function Divida() {
    }
    return Divida;
}());

var Devedor = /** @class */ (function () {
    function Devedor() {
    }
    return Devedor;
}());

var OpcoesPagamento = /** @class */ (function () {
    function OpcoesPagamento() {
    }
    return OpcoesPagamento;
}());

var Acordo = /** @class */ (function () {
    function Acordo() {
    }
    return Acordo;
}());

var Parcelas = /** @class */ (function () {
    function Parcelas() {
    }
    return Parcelas;
}());
...
/* harmony import */ var ngx_bootstrap_accordion__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-bootstrap/accordion */ "./node_modules/ngx-bootstrap/accordion/fesm5/ngx-bootstrap-accordion.js");
/* harmony import */ var ngx_bootstrap_chronos__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-bootstrap/chronos */ "./node_modules/ngx-bootstrap/chronos/fesm5/ngx-bootstrap-chronos.js");
/* harmony import */ var ngx_bootstrap_locale__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ngx-bootstrap/locale */ "./node_modules/ngx-bootstrap/locale/fesm5/ngx-bootstrap-locale.js");
...
var BoletoComponent = /** @class */ (function () {
    function BoletoComponent(modalService, route) {
    ...
    BoletoComponent.prototype.ngAfterViewInit = function () {
        var initialState = {
            writerProfileActive: true,
            smallInfoActive: false
        };
        this.modalRef = this.modalService.show(this.templateRef, { initialState: initialState, class: 'modal-lg' });
    };
    BoletoComponent.ctorParameters = function () { return [
...
var CpfCnpjBoxComponent = /** @class */ (function () {
    function CpfCnpjBoxComponent(http, router, cd, apiRestService) {
        this.http = http;
        this.router = router;
        this.cd = cd;
        this.apiRestService = apiRestService;
    ...
    CpfCnpjBoxComponent.prototype.clearAlerts = function () {
        this.cpf_inv = false;
        this.cnpj_inv = false;
        this.cpf_sem_debitos = false;
        this.cnpj_sem_debitos = false;
    ...
    CpfCnpjBoxComponent.prototype.clearDisclaimer = function () {
        ...
        switch (cpfCnpj.length) {
            case 11: {
                if (this.testaCPF(cpfCnpj)) {
                    ...
                    this.apiRestService.temDividasouAcordo(cpfCnpj).subscribe(function (res) {
...
var InputEmailComponent = /** @class */ (function () {
    function InputEmailComponent(apiRestService) {
        this.apiRestService = apiRestService;
    ...
    InputEmailComponent.prototype.cleanAlerts = function () {
        this.email_inv = false;
    };
    InputEmailComponent.prototype.validaEmail = function (email) {
        var re = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        return re.test(email.toLowerCase());
    };
    InputEmailComponent.prototype.envia = function () {
    ...
    InputEmailComponent.prototype.voltar = function () {
...
var InputTelComponent = /** @class */ (function () {
    function InputTelComponent(cd, apiRestService) {
        this.cd = cd;
        this.apiRestService = apiRestService;
        this.clickEnviar = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.clickVoltar = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    InputTelComponent.prototype.cleanAlerts = function () {
        this.tel_inv = false;
    };
    InputTelComponent.prototype.envia = function () {
    ...
    InputTelComponent.prototype.voltar = function () {
        this.clickVoltar.emit(true);
    };
...
var NegocieOnlineComponent = /** @class */ (function () {
    function NegocieOnlineComponent(apiRestService, cd) {
        this.apiRestService = apiRestService;
        this.cd = cd;
    ...
    NegocieOnlineComponent.prototype.ngOnDestroy = function () {
        // this.cd.detach();
    };
    ...
    NegocieOnlineComponent.prototype.botaoNaoClicavel = function () {
        return this.mostrarAbas.every(Boolean);
    };
    NegocieOnlineComponent.prototype.pagarAVista = function (codTitulo, valor, plano) {
    ...
    NegocieOnlineComponent.prototype.pagarParceladoTv = function (ind, codTitulo, plano) {
        this.apiRestService.parcelas = {
    ...
    NegocieOnlineComponent.prototype.pagarParceladoMovel = function (ind, codTitulo, plano) {
        this.apiRestService.parcelas = {
    ...
    NegocieOnlineComponent.prototype.pagarParceladoInternet = function (ind, codTitulo, plano) {
        this.apiRestService.parcelas = {
    ...
    NegocieOnlineComponent.prototype.pagarParceladoFixo = function (ind, codTitulo, plano) {
        this.apiRestService.parcelas = {
    ...
    NegocieOnlineComponent.prototype.getAllOpcoesClaroMovel = function () {
        var _this = this;
        ...
        if (this.apiRestService.dividasClaroMovel.Divida.DadosDivida.length) {
            ...
            this.apiRestService.dividasClaroMovel.Divida.DadosDivida.forEach(function (dados) { return _this.setOpcoes(dados.CodigoTitulo); });
        }
    ...
    NegocieOnlineComponent.prototype.getAllOpcoesClaroTv = function () {
        var _this = this;
        ...
        if (this.apiRestService.dividasClaroTv.Divida.DadosDivida.length) {
            if (this.apiRestService.dividasClaroTv.Divida.DadosDivida.length > 2)
                this.apiRestService.showDisclaimer = false;
            this.apiRestService.dividasClaroTv.Divida.DadosDivida.forEach(function (dados) { return _this.setOpcoes(dados.CodigoTitulo); });
        }
    };
    NegocieOnlineComponent.prototype.getAllOpcoesClaroInternet = function () {
        var _this = this;
        ...
        if (this.apiRestService.dividasClaroInternet.Divida.DadosDivida.length) {
            if (this.apiRestService.dividasClaroInternet.Divida.DadosDivida.length > 2)
                this.apiRestService.showDisclaimer = false;
            this.apiRestService.dividasClaroInternet.Divida.DadosDivida.forEach(function (dados) { return _this.setOpcoes(dados.CodigoTitulo); });
        }
    };
    NegocieOnlineComponent.prototype.getAllOpcoesClaroFixo = function () {
        var _this = this;
        ...
        if (this.apiRestService.dividasClaroFixo.Divida.DadosDivida.length) {
            if (this.apiRestService.dividasClaroFixo.Divida.DadosDivida.length > 2)
                this.apiRestService.showDisclaimer = false;
            this.apiRestService.dividasClaroFixo.Divida.DadosDivida.forEach(function (dados) { return _this.setOpcoes(dados.CodigoTitulo); });
        }
    };
    NegocieOnlineComponent.prototype.setOpcoes = function (cod) {
        var _this = this;
        var dadosDividaCod = this.dadosDivida.filter(function (dados) { return dados.CodigoTitulo === cod; });
        this.apiRestService.opcoesPg[dadosDividaCod[0].CodigoTitulo].subscribe(function (res) {
            _this.opcoesPg[dadosDividaCod[0].CodigoTitulo] = res.OpcoesPagamento;
            console.log("RES.OPCOESPAGAMENTO=");
            console.log(res.OpcoesPagamento);
            if (!_this.loadingParcelados && !res.Carregando) {
                _this.loadingParcelados = true;
                setTimeout(function () {
                    _this.loader = false;
                }, 2000);
            }
    ...
    NegocieOnlineComponent.prototype.getValorTotal = function (cod) {
    ...
    NegocieOnlineComponent.prototype.getValorNegociar = function (cod) {
    ...
    NegocieOnlineComponent.prototype.getOpcaoFixo = function (ind) {
    ...
    NegocieOnlineComponent.prototype.getOpcaoTv = function (ind) {
    ...
    NegocieOnlineComponent.prototype.getOpcaoMovel = function (ind) {
        /*console.log("this.apiRestService.dividasClaroTv.Divida.DadosDivida[this.ind_parcelado].CodigoTitulo=");
        console.log(this.apiRestService.dividasClaroTv.Divida.DadosDivida[this.ind_parcelado].CodigoTitulo);
        console.log("this.opcoesPg=");
        console.log(this.opcoesPg);
    ...
    NegocieOnlineComponent.prototype.getOpcaoInternet = function (ind) {
        /*console.log("this.apiRestService.dividasClaroTv.Divida.DadosDivida[this.ind_parcelado].CodigoTitulo=");
        console.log(this.apiRestService.dividasClaroTv.Divida.DadosDivida[this.ind_parcelado].CodigoTitulo);
        console.log("this.opcoesPg=");
        console.log(this.opcoesPg);
    ...
    NegocieOnlineComponent.prototype.showOpcoesParcelamento = function (ind) {
    ...
    NegocieOnlineComponent.prototype.hideOpcoesParcelamento = function () {
        this.opcoesParcelamento = false;
        this.showFatura = true;
        this.prazoFinalizacao = false;
    };
...
var OpcoesRoutletComponent = /** @class */ (function () {
    ...
    OpcoesRoutletComponent.prototype.voltarInicio = function () {
        window.open("/");
    };
...
var PrazoFinalizacaoComponent = /** @class */ (function () {
    function PrazoFinalizacaoComponent(localeService, apiRestService, router) {
    ...
    PrazoFinalizacaoComponent.prototype.enviarEmail = function () {
        var _this = this;
        this.apiRestService.enviaBoletoEmail(this.numeroTitulo, this.boleto.BoletoAcordo.Valor, this.boleto.BoletoAcordo.DataVencimento, this.boleto.BoletoAcordo.LinhaDigitavel, this.apiRestService.email).subscribe(function (res) {
            _this.emailRes = res.message;
            _this.porEmail = false;
            _this.sucesso = true;
        });
    };
    PrazoFinalizacaoComponent.prototype.voltarEmail = function () {
        this.porEmail = false;
        this.sucesso = true;
    };
    PrazoFinalizacaoComponent.prototype.voltarSms = function () {
        this.porSms = false;
        this.sucesso = true;
        this.smsRes = '';
    };
    ...
    PrazoFinalizacaoComponent.prototype.voltar_data = function () {
        this.clickVoltarAVista.emit(true);
    };
    PrazoFinalizacaoComponent.prototype.valorAVista = function () {
        if (this.apiRestService.parcelas.aVista)
            return this.apiRestService.doisDigitosDecimais(this.apiRestService.parcelas.aVista);
    };
    PrazoFinalizacaoComponent.prototype.primeiraParcelado = function () {
    ...
    PrazoFinalizacaoComponent.prototype.vezesParcelado = function () {
        if (this.apiRestService.parcelas.vezes)
            return this.apiRestService.parcelas.vezes;
    };
    PrazoFinalizacaoComponent.prototype.outrasParcelado = function () {
    ...
    PrazoFinalizacaoComponent.prototype.abrirBoleto = function () {
        var _this = this;
        var codigoParcelaAcordo;
        if (!this.boleto) {
            this.loader = true;
            this.apiRestService.getDadosAcordo(this.apiRestService.codTitulo).subscribe(function (acc) {
                console.log("acc=");
                console.log(acc);
                if (acc.Acordo.DadosAcordo.ParcelasAcordo.ParcelaAcordo.length)
                    codigoParcelaAcordo = acc.Acordo.DadosAcordo.ParcelasAcordo.ParcelaAcordo[0].CodigoParcelaAcordo;
                    ...
                    codigoParcelaAcordo = acc.Acordo.DadosAcordo.ParcelasAcordo.ParcelaAcordo.CodigoParcelaAcordo;
                _this.numeroTitulo = acc.Acordo.DadosAcordo.NumeroTitulo.split('.')[0];
                _this.apiRestService.getBoletoAcordo(_this.codAcordo, codigoParcelaAcordo).subscribe(function (bol) {
                    console.log(bol);
                    _this.loader = false;
                    if (bol.BoletoAcordo) {
                        _this.boleto = bol;
                        ...
                        _this.router.navigate(['/boleto'], { queryParams: { data: bol.BoletoAcordo.DataVencimento, linha: bol.BoletoAcordo.LinhaDigitavel, valor: _this.apiRestService.doisDigitosDecimais(bol.BoletoAcordo.Valor), cliente: _this.apiRestService.devedor.Devedores.Devedor.Nome, contrato: _this.numeroTitulo } });
                    }
                    else {
                        _this.erroBoleto = true;
                    }
    ...
    PrazoFinalizacaoComponent.prototype.gravaAcordo = function () {
        var _this = this;
        this.loader = true;
        this.fim = false;
        if (this.apiRestService.parcelas.aVista) {
            console.log(this.dataPagamento.toLocaleString().slice(0, 10));
            this.apiRestService.gravaAcordo(this.apiRestService.codTitulo, this.apiRestService.cpfCnpj, this.apiRestService.devedor.Devedores.Devedor.CodigoDevedor, '1', this.dataPagamento.toLocaleString().slice(0, 10), this.apiRestService.parcelas.aVista).subscribe(function (res) {
                console.log(res);
                _this.loader = false;
                if (res.Codigo === '12') {
                    _this.fim = false;
                    _this.sucesso = true;
                    _this.codAcordo = res.CodigoAcordo;
                    _this.apiRestService.telaFinal = true;
                }
                else {
                    _this.erro = true;
                    _this.fim = true;
            ...
            this.apiRestService.gravaAcordo(this.apiRestService.codTitulo, this.apiRestService.cpfCnpj, this.apiRestService.devedor.Devedores.Devedor.CodigoDevedor, this.apiRestService.plano, this.dataPagamento.toLocaleString().slice(0, 10), this.apiRestService.parcelas.primeira).subscribe(function (res) {
                console.log(res);
                _this.loader = false;
                if (res.Codigo === '12') {
                    _this.fim = false;
    ...
    PrazoFinalizacaoComponent.prototype.enviarSms = function () {
        var _this = this;
        this.apiRestService.enviaSms(this.boleto.BoletoAcordo.LinhaDigitavel, this.boleto.BoletoAcordo.DataVencimento, this.apiRestService.doisDigitosDecimais(this.boleto.BoletoAcordo.Valor)).subscribe(function (res) {
            _this.smsRes = JSON.parse(res).statusDescription;
            _this.porSms = false;
    ...
    PrazoFinalizacaoComponent.prototype.pegarTelefone = function () {
        var _this = this;
        this.sucesso = false;
        var codigoParcelaAcordo;
        if (!this.boleto) {
    ...
    PrazoFinalizacaoComponent.prototype.pegarEmail = function () {
        var _this = this;
        var codigoParcelaAcordo;
        this.smsRes = '';
        this.sucesso = false;
    ...
    PrazoFinalizacaoComponent.ctorParameters = function () { return [
