...
var ApiRestService = /** @class */ (function () {
    ...
    ApiRestService.prototype.notificarMotor = function (id) {
...
var CpfCnpjBoxComponent = /** @class */ (function () {
    ...
    CpfCnpjBoxComponent.prototype.cleanAlertsAndDisclaimer = function () {
        this.cpf_inv = false;
        this.cnpj_inv = false;
        this.cpf_sem_debitos = false;
        this.cnpj_sem_debitos = false;
...
var NegocieOnlineComponent = /** @class */ (function () {
    ...
    NegocieOnlineComponent.prototype.getAllOpcoesClaroInternet = function () {
        ...
        if (!this.apiRestService.getAllOpcoesClaroInternet()) {
            this.showHeader = false;
            this.movelLabel = true;
            this.dadosDivida.forEach(function (dados) { return _this.setOpcoes(dados.CodigoTitulo); });
        }
    };
...
var PrazoFinalizacaoComponent = /** @class */ (function () {
        ...
        this.apiRestService.getDadosAcordo(this.apiRestService.codTitulo).subscribe(function (acc) {
            ...
            _this.apiRestService.getBoletoAcordo(_this.codAcordo, codigoParcelaAcordo).subscribe(function (bol) {
                ...
                if (bol.BoletoAcordo) { ///////////////////////////////////////////////////////////////////
                    ...
                    _this.router.navigate(['/boleto'], { queryParams: { data: bol.BoletoAcordo.DataVencimento, linha: bol.BoletoAcordo.LinhaDigitavel, valor: bol.BoletoAcordo.Valor, cliente: _this.apiRestService.devedor.Devedores.Devedor.Nome, contrato: numeroTitulo } });
                }
                else {
                    _this.erroBoleto = true;
                }
    ...
    PrazoFinalizacaoComponent.prototype.gravaAcordo = function () {
        ...
        this.fim = false;
        if (this.apiRestService.parcelas.aVista) {
            this.apiRestService.gravaAcordo(this.apiRestService.codTitulo, this.apiRestService.cpfCnpj, this.apiRestService.devedor.Devedores.Devedor.CodigoDevedor, this.apiRestService.plano, this.dataPagamento.toLocaleString().split(',')[0], this.apiRestService.parcelas.aVista).subscribe(function (res) {
                console.log(res);
                _this.loader = false;
                if (res.Codigo === '12') {
                    _this.fim = false;
            ...
            this.apiRestService.gravaAcordo(this.apiRestService.codTitulo, this.apiRestService.cpfCnpj, this.apiRestService.devedor.Devedores.Devedor.CodigoDevedor, this.apiRestService.plano, this.dataPagamento.toLocaleString().split(',')[0], this.apiRestService.parcelas.primeira).subscribe(function (res) {
                console.log(res);
                _this.loader = false;
                if (res.Codigo === '12') {
                    _this.fim = false;
    ...
    PrazoFinalizacaoComponent.prototype.enviarSms = function () {
        var _this = this;
        this.apiRestService.enviaSms(this.boleto.BoletoAcordo.LinhaDigitavel, this.boleto.BoletoAcordo.DataVencimento, this.boleto.BoletoAcordo.Valor).subscribe(function (res) {
            _this.sucessoSms = true;
            console.log("RES SMS=");
            console.log(res);
        });
    };
