...
var AcordosAndamentoComponent = /** @class */ (function () {
    function AcordosAndamentoComponent(apiRestService) {
    ...
    AcordosAndamentoComponent.prototype.segunda_via = function (codAcordo, codCodigoAcordo, ind) {
        var _this = this;
        ...
        this.apiRestService.getBoletoAcordo(codAcordo, codCodigoAcordo).subscribe(function (bol) {
            ...
            if (bol.BoletoAcordo) {
                window.open("/boleto?data=" + bol.BoletoAcordo.DataVencimento + "&linha=" + bol.BoletoAcordo.LinhaDigitavel + "&valor=" + bol.BoletoAcordo.Valor + "&cliente=" + _this.apiRestService.getNome());
            }
            else {
...
var ApiRestService = /** @class */ (function () {
    ...
    ApiRestService.prototype.notificarMotor = function (id) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('cpf', this.cpfCnpj)
    ...
    ApiRestService.prototype.testee = function () {
        var cpfCnpjParam = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('cpf', '10805480765');
        return this.http.post(this.urlDadosDevedor, cpfCnpjParam, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (devedor) {
            return devedor;
        }));
    };
    ...
    ApiRestService.prototype.getDividas = function () {
        ...
        if (this.dividas.Divida.DadosDivida.length) {
            ...
            this.dividasClaroTv.Divida.DadosDivida = this.dividas.Divida.DadosDivida.filter(function (div) { console.log("div this.dividas.Divida.DadosDivida="); console.log(_this.dividas.Divida.DadosDivida); return div.Produto === "Claro TV"; });
        }
        else {
    ...
    ApiRestService.prototype.getAllOpcoesClaroTv = function () {
        ...
        this.dividasClaroTv.Divida.DadosDivida.forEach(function (divida) {
            ...
            console.log(_this.opcoesPg[divida.CodigoTitulo]);
            _this.getOpcoesPagamento(divida.CodigoTitulo).subscribe(function (opc) {
                opc.Carregando = false;
...
var NegocieOnlineComponent = /** @class */ (function () {
    ...
    NegocieOnlineComponent.prototype.pagarParcelado = function (ind, codTitulo, plano) {
        this.apiRestService.parcelas = {
    ...
    NegocieOnlineComponent.prototype.getOpcao = function (ind) {
...
var PrazoFinalizacaoComponent = /** @class */ (function () {
    function PrazoFinalizacaoComponent(localeService, apiRestService) {
